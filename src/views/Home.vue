  ...
  <div>
      ...
      >
        ...
        >
          ...
          >
            ...
            melakukan pembelajaran menggunakan Sion.
          </p>
          <div
            data-aos="fade-up"
            data-aos-once="true"
    ...
    >
      ...
      <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
        ...
        <p class="leading-relaxed text-gray-500">
          Sion dibuat dengan menggabungkan beberapa metode pembelajaran
      ...
      <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
        ...
        >
          ...
          <p class="px-4 text-gray-500">
            Penugasan & Ulangan dapat dikerjakan langsung didalam Sion,
        ...
        >
          ...
          <p class="px-4 text-gray-500">
            Sion dapat menampilkan siapa saja user yang sedang Online didalam
            aplikasi.
          </p>
        </div>
      </div>
      ...
      <div class="mt-28">
        <div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
          <h1 class="text-3xl font-bold mb-4">
            Apa itu<span class="text-primary"> Sion?</span>
          </h1>
          <p class="text-gray-500">
            Sion adalah sebuah platform pembelajaran secara online yang
      ...
      <div class="sm:flex items-center sm:space-x-8 mt-36">
        <div data-aos="fade-right" class="sm:w-1/2 relative">
          ...
          <h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">
            Semua yang dapat Anda lakukan di ruang kampus,
            <span class="text-primary">Dapat dilakukan di Sion</span>
          </h1>
          <p class="py-5 lg:pr-32">
            Sion memanajemen segala aktivitas yang dilakukan di sekolah secara online.
      ...
      >
        <div data-aos="zoom-in-right" class="md:w-5/12">
          ...
          <p class="text-gray-500 my-5 lg:pr-36">
            Sion telah mendapatkan 10k respon positif dari para pengguna.
          </p>
          <p class="text-gray-500 my-5 lg:pr-36">
            banyak siswa yang terbantu dengan platform Sion.
          </p>
          <p class="text-gray-500 my-5 lg:pr-36">
    ...
    <footer class="mt-32" style="background-color: rgba(37, 38, 65, 1)">
      <div class="max-w-lg mx-auto">
        ...
        >
          <div class="relative">
            <h1 class="font-bold text-xl pr-5 relative z-50">Sion</h1>
            <svg
        ...
        <div class="text-center text-white">
          <p class="my-3 text-gray-400 text-sm">
            &copy; 2022 Class Ekadharma.
          </p>
          <div class="py-3 tracking-wide">
            <!-- <p>
              &copy; <span class="font-semibold"> 2022 Ekadharma</span>
            </p> -->
          </div>
        </div>
      </div>
